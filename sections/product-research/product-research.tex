...
Theo báo cáo Digital 2026 \cite{datareportal2026}, Việt Nam hiện có khoảng 85,6 triệu người dùng Internet (chiếm 84,2\% dân số). Với độ tuổi trung bình là 33,4, tập khách hàng của các nền tảng OTT vô cùng đa dạng, dẫn đến những khác biệt rõ rệt về năng lực tiếp nhận công nghệ và kỳ vọng trải nghiệm.
...
Dựa trên các nghiên cứu chuyên sâu về thị trường streaming thể thao \cite{kantar2026,disneyadvertising2025,parksassociates2025}, nhóm nghiên cứu phân loại người dùng VTVPrime thành các phân khúc dựa trên động cơ và bối cảnh sử dụng:
...
\subsubsection{Người dùng mới (First-time user) vs Người dùng quen thuộc (Power user)}
...
\subsubsection{Người dùng xem trên thiết bị di động (Mobile) vs Desktop}
...
\subsubsection{Người dùng ở khu vực có kết nối Internet chậm / không ổn định}
...
\subsubsection{Người dùng không rành về công nghệ / thanh toán trực tuyến}
\begin{itemize}[leftmargin=2em]
...
\subsubsection{Người dùng sử dụng trong môi trường ánh sáng mạnh (ngoài trời)}
\begin{itemize}[leftmargin=2em]
...
\subsubsection{Người dùng muốn so sánh gói cước nhanh}
\begin{itemize}[leftmargin=2em]
...
\hline
Recognition \& Recall & Tốt: Carousel có đề mục rõ ràng, lịch phát sóng timeline & Tốt: Biểu tượng môn thể thao rõ ràng, layout tương đồng Netflix \\
\hline
Learnability & Khá: Pattern nhất quán nhưng một số nút thiếu nhất quán & Tốt: Layout quen thuộc, dễ học cho người dùng Netflix \\
\hline
Consistency & Kém: Nút ``Xem tất cả'' không nhất quán, định dạng card phim bộ khác nhau & Tốt: Layout nhất quán, mô phỏng pattern quen thuộc \\
\hline
Capabilities (Fitts) & Kém: Mũi tên carousel nhỏ, nút chat quá nhỏ, khoảng cách hamburger/close lớn & Khá: Nút điều khiển đủ lớn nhưng danh sách cuộn ngang gây motor load \\
\hline
Error Prevention & Khá: Có badge trạng thái nhưng lịch phát sóng không phân biệt rõ & Kém: Thiếu bước tóm tắt đơn hàng trước thanh toán, dễ mua nhầm gói \\
\hline
Feedback & Kém: Không có thông báo khi hết nội dung khi cuộn & Tốt: Hệ thống tối ưu độ phân giải tự động, feedback rõ ràng \\
\hline
Reachability & Khá: Nút điều khiển tự ẩn khi xem & Kém: Quảng cáo che khuất nội dung cốt lõi, giảm reachability \\
\hline
Inclusive Design & Kém: Chữ nhỏ, biểu tượng phức tạp, không phù hợp người lớn tuổi & Khá: Layout quen thuộc nhưng danh sách cuộn ngang khó thao tác \\
\hline
\end{tabularx}
\end{center}
...
Phân tích chi tiết hai nền tảng OTT thể thao từ góc độ HCI cho thấy mỗi sản phẩm đều có điểm mạnh và yếu riêng. VTVPrime ưu thế trong việc tổ chức nội dung theo carousel có đề mục rõ ràng, lịch phát sóng timeline với badge trạng thái, và pattern carousel nhất quán giúp Recognition \& Recall. Tuy nhiên, nền tảng này gặp vấn đề về Consistency (nút ``Xem tất cả'' không nhất quán, định dạng card khác nhau), vi phạm định luật Fitts (mũi tên carousel nhỏ, nút chat quá nhỏ), và thiếu feedback khi hết nội dung.

FPTPlay có layout quen thuộc tương đồng Netflix giúp Learnability, biểu tượng môn thể thao rõ ràng hỗ trợ Recognition over Recall, và hệ thống tối ưu độ phân giải tự động đảm bảo trải nghiệm xem không gián đoạn. Ngược lại, nền tảng này có vấn đề về Error Prevention (thiếu bước tóm tắt đơn hàng trước thanh toán), ưu tiên quảng cáo hơn nội dung cốt lõi vi phạm Visibility, và danh sách môn thể thao dạng cuộn ngang vô tận gây motor load.

Tổng thể, phân tích cho thấy cả hai nền tảng đều cần giải quyết các vấn đề về Consistency, Error Prevention, và Visibility để nâng cao trải nghiệm người dùng, đồng thời cân bằng giữa việc tối ưu hóa các thành phần tương tác theo định luật Fitts và đảm bảo feedback rõ ràng cho người dùng.
...
%          TÀI LIỆU THAM KHẢO
% ======================================================
% Bibliography được tạo tự động từ file references.bib
% Danh sách tài liệu tham khảo sẽ hiển thị ở cuối tài liệu


% ======================================================
%          PHỤ LỤC
% ======================================================
% Appendix được gọi trong main.tex
% HCI principles được import trực tiếp trong main.tex
