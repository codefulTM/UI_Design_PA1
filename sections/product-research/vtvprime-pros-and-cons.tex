...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image1.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image2.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image3.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image4.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  \item \textbf{Phân tích}: Mỗi card trong trang có hiệu ứng hover nhẹ khi di chuột vào, báo hiệu cho người dùng rằng đây là phần tử có thể click được. Nút ``Xem tất cả'' sử dụng ký hiệu mũi tên gợi ý điều hướng sang trang mới. Mũi tên carousel trái/phải gợi ý có thể cuộn ngang để xem thêm nội dung.
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image6.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image7.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image8.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image9.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image10.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image11.drawio.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image12.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image15.drawio.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image16.drawio.png}
  \end{center}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image17.drawio.png}
  \end{center}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image18.drawio.png}
  \end{center}
  \item \textbf{Đề xuất hướng khắc phục}: Thêm dòng text như ``Đã hiển thị tất cả nội dung''.
\end{itemize}

\subsubsection{Nhược điểm 4: Nút ``Xem tất cả'' không nhất quán giữa các section}

\begin{itemize}
  \item \textbf{Phân tích}: Internal consistency yêu cầu các thành phần \textbf{cùng chức năng} phải hoạt động giống nhau ở mọi nơi. Các carousel trong trang có chức năng hiển thị một phần thông tin nhưng chỉ một số carousel có nút bấm ``Xem tất cả'' (cho phép xem toàn bộ thông tin), nhiều carousel khác thì không. Điều này phá vỡ pattern recognition: Người dùng học được pattern ``heading + Xem tất cả'' ở carousel đầu tiên. Họ kỳ vọng carousel sau cũng có, nhưng thật ra là không.
  \item \textbf{Nguyên tắc liên quan}: Consistency.
  \item \textbf{Ví dụ cụ thể}:
  \begin{quote}
    Người dùng A thấy carousel ``World Cup 2026\texttrademark{}'' có nút ``Xem tất cả'' bên phải, họ click vào và xem được toàn bộ danh sách các video. Tiếp tục lướt xuống, A thấy section ``Muôn Màu World Cup'' cũng là carousel tương tự, kỳ vọng sẽ có ``Xem tất cả'' nhưng không có. A thắc mắc: ``Tại sao section này không có? Vậy mình phải làm sao để xem tất cả các nội dung đây? Chẳng lẽ mình phải lướt hết carousel? Lỡ nếu carousel này dài quá thì sao? Mình sẽ tốn bao nhiêu thời gian để lướt hết carousel này? Mình có nên lướt tiếp không?'' mất thời gian tìm kiếm và bị bỡ ngỡ.
  \end{quote}
  \begin{quote}
    ``World Cup 2026\texttrademark{}'' có nút ``Xem tất cả''.
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image19.drawio.png}
  \end{center}
  \begin{quote}
    ``Muôn Màu World Cup'' không có nút này.
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image20.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image5.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image13.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image14.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image21.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image22.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image23.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  \item \textbf{Phân tích HCI}: Trên giao diện tablet, nút hamburger (biểu tượng ba dấu gạch ngang) nằm ở sát bên trái navbar --- vị trí này hợp lý. Tuy nhiên, khi bấm vào hamburger thì sidebar mở rộng full màn hình, và nút \ensuremath{\times} (đóng) lại nằm ở \textbf{sát bên phải} màn hình \ensuremath{\rightarrow} khoảng cách di chuyển từ nút hamburger (bên trái) đến nút \ensuremath{\times} (bên phải) rất lớn, buộc người dùng phải di chuyển ngón tay một quãng dài trên tablet --- tăng motor load đáng kể. Theo nguyên tắc \textbf{Reachability \& Motor Load}, các phần tử tương tác thường xuyên nên được đặt ở vị trí dễ chạm tới với nỗ lực vận động tối thiểu.
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image24.png}
  \end{center}
  \begin{center}
    \includegraphics[width=\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image25.png}
  \end{center}
