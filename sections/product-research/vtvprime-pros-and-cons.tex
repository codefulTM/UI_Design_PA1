...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image1.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image2.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image3.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image4.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image6.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image7.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image8.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image9.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image10.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image11.drawio.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image12.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image15.drawio.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image16.drawio.png}
  \end{center}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image17.drawio.png}
  \end{center}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image18.drawio.png}
  \end{center}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image19.drawio.png}
  \end{center}
  \begin{quote}
    ``Muôn Màu World Cup'' không có nút này.
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image20.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image5.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image13.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image14.drawio.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image21.png}
  \end{center}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image22.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image23.png}
  \end{center}
\end{itemize}
...
\begin{itemize}
  ...
  \end{quote}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image24.png}
  \end{center}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{./sections/product-research/vtvprime-product-research-imgs/image25.png}
  \end{center}
